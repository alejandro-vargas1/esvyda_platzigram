...
SECRET_KEY = 'django-insecure-m(9gyk7au&epr7gei4-2_+0=2y-1#(p60(bbt9si+bf^@q(ug3'
...
MEDIA_ROOT = BASE_DIR / 'media/' #NO PONER "/" AL INICIO, SE REFERIRIA AL DIRECTORIO DE (LINUX)
MEDIA_URL = 'media/'
